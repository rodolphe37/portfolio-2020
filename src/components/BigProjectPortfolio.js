    ...
    <div className="w3-container w3-light-grey" style={{ padding: '128px 16px' }} id="bigProject">
      <div className="w3-row-padding">
        <div className="w3-col m6">
          ...
          <h5>Le site sera très prochainement en ligne, le portfolio sur lequel vous surfez est la reproduction "en React" d'une petite partie du site amano-hilot</h5>
